...
figure()
subplot(2,2,1),plot(x, Red, 'r', x, Green, 'g', x, Blue, 'b');
title('Inspecting Large Peaks')
subplot(2,2,3), imshow(R>200)
title('Red Channel')
subplot(2,2,2), imshow(G>150)
title('Green Channel')
subplot(2,2,4), imshow(B>175)
title('Blue Channel')

figure()
subplot(2,2,1),plot(x, Red, 'r', x, Green, 'g', x, Blue, 'b');
title('Inspecting Middle Peaks')
subplot(2,2,3), imshow(R>150 & R<200)
title('Red Channel')
subplot(2,2,2), imshow(G>100 & G<150)
title('Green Channel')
subplot(2,2,4), imshow(B>125 & B<175)
title('Blue Channel')

figure()
subplot(2,2,1),plot(x, Red, 'r', x, Green, 'g', x, Blue, 'b');
title('Inspecting Lowest Peaks')
subplot(2,2,3), imshow(R<150)
title('Red Channel')
subplot(2,2,2), imshow(G<100)
title('Green Channel')
subplot(2,2,4), imshow(B<125)
title('Blue Channel')
...
%%
%
% Above are the binary images after performing color channel operations.
% From inspection, all 6 Leukocytes
...
figNum = 101; % figure number
a = 101;
b = 400;

batch = unique(round((b-a).*rand(10,1) + a));
...
%
% Based on the above results, it is
